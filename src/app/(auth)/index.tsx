...
export default function Login() {
  ...
  return (
    <ScrollView automaticallyAdjustKeyboardInsets>
      <View className="items-center justify-center flex-1 min-h-screen p-6 bg-white">
        <Image
        ...
        <Text className="mb-6 font-semibold text-zinc-700">
          Pdf Storage App
        </Text>
        ...
        <View className="w-full gap-4">
          ...
          <Text className="text-sm text-center text-zinc-400">
            ...
            <Link href="/forget-password">
              <Text className="font-bold text-primary">clique aqui</Text>
            </Link>
          </Text>
        </View>
      </View>
